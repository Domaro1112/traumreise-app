...
const MF = '/images/motorradurlaub/funnel';   // funnel-specific (may not exist yet)
const FB = '/images/funnel/cards';            // fallback cards (always exist)
...
export const QUESTIONS = [
  {
    ...
    options: [
      { value: 'short',    label: '3–5 Tage',    hint: 'Kurztrip',           img: `${MF}/duration-weekend.png`,   fallbackImg: `${FB}/active.jpg`,    bg: '#162040' },
      { value: 'week',     label: '1 Woche',      hint: 'Klassische Tour',    img: `${MF}/duration-one-week.png`,  fallbackImg: `${FB}/mountain.jpg`,  bg: '#0F3460' },
      { value: 'twoweeks', label: '2 Wochen',     hint: 'Ausgedehnte Reise',  img: `${MF}/duration-two-weeks.png`, fallbackImg: `${FB}/world.jpg`,     bg: '#1a3020' },
      { value: 'long',     label: 'Länger',       hint: 'Große Motorradreise',img: `${MF}/duration-longer.png`,   fallbackImg: `${FB}/backpack.jpg`,  bg: '#221a44' },
    ],
  },
  {
    id: 'dailyKm',
    ...
    options: [
      { value: 'low',   label: 'Bis 150 km',  hint: 'Gemütlich', img: `${MF}/distance-short.png`,     fallbackImg: `${FB}/relax.jpg`,    bg: '#1a4a2e' },
      { value: 'mid',   label: '150–300 km',  hint: 'Ausgewogen', img: `${MF}/distance-medium.png`,    fallbackImg: `${FB}/active.jpg`,   bg: '#162040' },
      { value: 'high',  label: '300–500 km',  hint: 'Sportlich',  img: `${MF}/distance-long.png`,      fallbackImg: `${FB}/mountain.jpg`, bg: '#0F2A4C' },
      { value: 'ultra', label: '500+ km',     hint: 'Ausdauer',   img: `${MF}/distance-very-long.png`, fallbackImg: `${FB}/backpack.jpg`, bg: '#1e1020' },
    ],
  },
  {
    id: 'style',
    ...
    options: [
      { value: 'curves',    label: 'Kurvenreiche Strecken', hint: 'Fahrdynamik', img: `${MF}/style-curves.png`,          fallbackImg: `${FB}/mountain.jpg`, bg: '#162040' },
      { value: 'passes',    label: 'Bergpässe',             hint: 'Höhenrausch', img: `${MF}/style-mountain-passes.png`, fallbackImg: `${FB}/mountain.jpg`, bg: '#0F3460' },
      { value: 'coast',     label: 'Küstenstraßen',         hint: 'Meerblick',   img: `${MF}/style-coastal-roads.png`,   fallbackImg: `${FB}/beach.jpg`,    bg: '#0F2A4C' },
      { value: 'landscape', label: 'Landschaft genießen',   hint: 'Natur pur',   img: `${MF}/style-scenic.png`,          fallbackImg: `${FB}/autumn.jpg`,   bg: '#1a3020' },
      { value: 'cruising',  label: 'Entspanntes Cruisen',   hint: 'Ohne Eile',   img: `${MF}/style-cruising.png`,        fallbackImg: `${FB}/relax.jpg`,    bg: '#1a2818' },
    ],
  },
  {
    id: 'destination',
    ...
    options: [
      { value: 'germany',     label: 'Deutschland',   hint: 'Heimat entdecken', img: `${MF}/destination-germany.png`,     fallbackImg: `${FB}/autumn.jpg`,   bg: '#182018' },
      { value: 'alps',        label: 'Alpen',         hint: 'Pässe & Kulisse',  img: `${MF}/destination-alps.png`,        fallbackImg: `${FB}/mountain.jpg`, bg: '#162040' },
      { value: 'italy',       label: 'Italien',       hint: 'Dolce Vita',       img: `${MF}/destination-italy.png`,       fallbackImg: `${FB}/beach.jpg`,    bg: '#2a1800' },
      { value: 'france',      label: 'Frankreich',    hint: 'Savoir-vivre',     img: `${MF}/destination-france.png`,      fallbackImg: `${FB}/spring.jpg`,   bg: '#1e1020' },
      { value: 'scandinavia', label: 'Skandinavien',  hint: 'Fjorde & Weite',   img: `${MF}/destination-scandinavia.png`, fallbackImg: `${FB}/winter.jpg`,   bg: '#0F3460' },
      { value: 'open',        label: 'Ich bin offen', hint: 'Überrasch mich',   img: `${MF}/destination-open.png`,        fallbackImg: `${FB}/world.jpg`,    bg: '#1a1a34' },
    ],
  },
  {
    id: 'accommodation',
    ...
    options: [
      { value: 'hotel',   label: 'Hotel',   hint: 'Komfort & Service',   img: `${MF}/stay-hotel.png`,      fallbackImg: `${FB}/hotel.jpg`,    bg: '#162040' },
      { value: 'pension', label: 'Pension', hint: 'Persönlich & günstig', img: `${MF}/stay-guesthouse.png`, fallbackImg: `${FB}/resort.jpg`,   bg: '#1a4a2e' },
      { value: 'camping', label: 'Camping', hint: 'Freiheit & Natur',    img: `${MF}/stay-camping.png`,    fallbackImg: `${FB}/backpack.jpg`, bg: '#1a3020' },
      { value: 'any',     label: 'Egal',    hint: 'Je nach Lage',        img: `${MF}/stay-open.png`,       fallbackImg: `${FB}/relax.jpg`,    bg: '#1a2030' },
    ],
  },
  {
    id: 'parking',
    ...
    options: [
      { value: 'veryImportant', label: 'Sehr wichtig',         hint: 'Immer prüfen', img: `${MF}/parking-important.png`,     fallbackImg: `${FB}/hotel.jpg`,  bg: '#0F2A4C' },
      { value: 'niceToHave',    label: 'Schön wenn vorhanden', hint: 'Wäre gut',     img: `${MF}/parking-nice.png`,           fallbackImg: `${FB}/resort.jpg`, bg: '#162040' },
      { value: 'notImportant',  label: 'Nicht wichtig',        hint: 'Kein Thema',   img: `${MF}/parking-not-important.png`,  fallbackImg: `${FB}/relax.jpg`,  bg: '#1a3020' },
    ],
  },
];
