...
export const AFFILIATE_PROVIDERS = {
  ...
  centerparcs: {
    ...
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=13639&awinaffid=&ued=${encodeURIComponent('https://www.centerparcs.de/')}`,
  },
  landal: {
    ...
    category: 'Ferienparks & Familienurlaub',
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=9118&awinaffid=&ued=${encodeURIComponent('https://www.landal.de/')}`,
  },
  roompot: {
    name:    'Roompot',
    ...
    category: 'Ferienparks & Familienurlaub',
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=84299&awinaffid=&ued=${encodeURIComponent('https://www.roompot.de/')}`,
  },
  topparken: {
    name:    'TopParken',
    label:   'Parks ansehen',
    ...
    category: 'Ferienparks & Familienurlaub',
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=117131&awinaffid=&ued=${encodeURIComponent('https://www.topparken.de/')}`,
  },
  sunparks: {
    name:    'Sunparks',
    ...
    category: 'Ferienparks & Familienurlaub',
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=14749&awinaffid=&ued=${encodeURIComponent('https://www.sunparks.de/')}`,
  },
  eurocamp: {
    name:    'Eurocamp',
    ...
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=14888&awinaffid=&ued=${encodeURIComponent('https://www.eurocamp.de/')}`,
  },
  novasol: {
    name:    'NOVASOL',
    ...
    buildUrl: () =>
      `https://www.awin1.com/cread.php?awinmid=118655&awinaffid=&ued=${encodeURIComponent('https://www.novasol.de/')}`,
  },
