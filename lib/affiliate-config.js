/**
 * Affiliate-Konfiguration fürApeAround.
 *
...
export const AFFILIATE_PROVIDERS = {
  ...
  // buildUrl returns a full AWIN deeplink; awinaffid= is injected by generateAffiliateUrl.
  centerparcs: {
    name:    'Center Parcs',
    label:   'Ferienpark buchen',
    color:   '#005EB8',
    bgColor: '#EBF4FF',
    network: 'awin',
    awinMerchantId: 13639,
    category: 'Ferienparks & Familienurlaub',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=13639&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.centerparcs.de/ferienparks/')}`,
  },
  landal: {
    name:    'Landal GreenParks',
    label:   'Park entdecken',
    color:   '#00843D',
    bgColor: '#ECFDF5',
    network: 'awin',
    awinMerchantId: 9118,
    category: 'Ferienparks & Familienurlaub',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=9118&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.landal.de/ferienparks/')}`,
  },
  roompot: {
    name:    'Roompot',
    label:   'Urlaub entdecken',
    color:   '#E87722',
    bgColor: '#FFF7ED',
    network: 'awin',
    awinMerchantId: 84299,
    category: 'Ferienparks & Familienurlaub',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=84299&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.roompot.de/ferienwohnungen/')}`,
  },
  topparken: {
    name:    'TopParken',
    label:   'Parks ansehen',
    ...
    bgColor: '#EFF6FF',
    network: 'awin',
    awinMerchantId: 117131,
    category: 'Ferienparks & Familienurlaub',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=117131&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.topparken.de/')}`,
  },
  sunparks: {
    name:    'Sunparks',
    ...
    bgColor: '#FFFBEB',
    network: 'awin',
    awinMerchantId: 14749,
    category: 'Ferienparks & Familienurlaub',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=14749&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.sunparks.de/ferienparks/')}`,
  },
  eurocamp: {
    name:    'Eurocamp',
    label:   'Camping entdecken',
    color:   '#2E7D32',
    bgColor: '#F0FDF4',
    network: 'awin',
    awinMerchantId: 14888,
    category: 'Camping & Mobilheime',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=14888&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.eurocamp.de/campingplatze/')}`,
  },
  novasol: {
    name:    'NOVASOL',
    label:   'Ferienhaus finden',
    color:   '#C0392B',
    bgColor: '#FEF2F2',
    network: 'awin',
    awinMerchantId: 118655,
    category: 'Ferienhäuser',
    buildUrl: (targetUrl) =>
      `https://www.awin1.com/cread.php?awinmid=118655&awinaffid=&ued=${encodeURIComponent(targetUrl && targetUrl.startsWith('http') ? targetUrl : 'https://www.novasol.de/ferienhaeuser')}`,
  },
