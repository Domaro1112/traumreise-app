...
import { PenLine, Cpu, Map, Plane } from 'lucide-react';
import Container from '@/components/layout/Container';
import SectionTitle from '@/components/ui/SectionTitle';
import Button from '@/components/ui/Button';
import { howItWorksSteps } from '@/data/features';

const STEP_ICON_MAP = { PenLine, Cpu, Map };
      ...
      <Container>
        ...
        >
          {howItWorksSteps.map((step, idx) => {
            const StepIcon = STEP_ICON_MAP[step.icon] || Map;
            return (
              <div key={step.step} style={{ position: 'relative' }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '20px' }}>
                    ...
                    >
                      <StepIcon size={22} strokeWidth={1.5} color="#0EA5E9" />
                    </div>
                  </div>
