...
// ── Hero image ────────────────────────────────────────────────────────────────
// Place the image at: public/images/results/reiseinspiration-hero.jpg
// Missing file → gradient fallback (no broken icon)
...
function ResultsHero() {
  return (
    ...
    >
      {/* Image layer — silently falls back to gradient if file is missing */}
      <div
        aria-hidden="true"
        style={{
          position: 'absolute',
